...
DECLARE
    ...
    -- BELOW GETS SET TO CORRECT VALUE WHEN LOADING db DATA, LOOK AT entrypoint_scripts/90_gnaf_db_setup.sh SCRIPT!
    file_path_prefix TEXT := '${REPLACE_WITH_PATH_PREFIX}/';
